...
This is a **non-profit experimental** software in its **Beta** version, so be aware that some **bugs** can happen during the execution. Please **save** your projects as often as you can and [**let us know** <i class="fa-solid fa-up-right-from-square" style="font-size: 12px;"></i>](https://github.com/gbayarri/biomovies-app/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=) if some bug is found.
